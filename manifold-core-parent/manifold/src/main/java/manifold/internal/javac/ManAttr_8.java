...
//    }
  ...
  {
    Type methType = meth.sym.type;
    while( methType instanceof Type.DelegatedType )
    {
      methType = ((Type.DelegatedType)methType).qtype;
    }
    ((Type.MethodType)methType).restype = returnExprType;
