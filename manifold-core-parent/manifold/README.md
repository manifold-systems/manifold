...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold', version: '2022.1.30'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold', version: '2022.1.30'
}
...
`manifold`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold/2022.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold/2022.1.30)

`manifold-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-rt/2022.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-rt/2022.1.30)
