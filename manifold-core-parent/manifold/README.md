...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold', version: '2024.1.48'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold', version: '2024.1.48'
}
...
`manifold`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold/2024.1.48/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold/2024.1.48)

`manifold-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-rt/2024.1.48/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-rt/2024.1.48)
