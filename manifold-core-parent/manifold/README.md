...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold', version: '2023.1.34'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold', version: '2023.1.34'
}
...
`manifold`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold/2023.1.34/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold/2023.1.34)

`manifold-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-rt/2023.1.34/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-rt/2023.1.34)
