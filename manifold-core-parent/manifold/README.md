...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold', version: '2022.1.37'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold', version: '2022.1.37'
}
...
`manifold`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold/2022.1.37/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold/2022.1.37)

`manifold-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-rt/2022.1.37/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-rt/2022.1.37)
