...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold', version: '2026.1.10'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold', version: '2026.1.10'
}
...
`manifold`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold/2026.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold/2026.1.10)

`manifold-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-rt/2026.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-rt/2026.1.10)
