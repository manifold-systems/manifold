...
public class CompiletimeErrorTest {
    ...
    public void ExtendsErrorTest() {
        ...
        generator.generateCode("testing.tester",
                "<%@ extends ExtendsTesterTemplate %><%@ extends ExtendsTesterTemplate %>",
                "tester.manifold.templates.html");
        generator.generateCode("testing.tester",
                "<%@ section mySection %><%@ extends ExtendsTesterTemplate %><%@ extends ExtendsTesterTemplate %><%@ end section %>",
                "tester.manifold.templates.html");
    ...
    public void SectionErrorTest() {
        TemplateGen generator = new TemplateGen();
        generator.generateCode("testing.tester",
                "<%@ section mySection %><%@ extends ExtendsTesterTemplate %><%@ end section %>",
                "tester.manifold.templates.html");
        generator.generateCode("testing.tester",
                "<%@ section mySection %><%@ params(String name, int age) %><%@ end section %>",
                "tester.manifold.templates.html");
