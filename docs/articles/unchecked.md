...
dependencies {
    ...
    compile group: 'systems.manifold', name: 'manifold-exceptions', version: '2020.1.15'

    // Add manifold-exceptions to -processorpath for javac (for Java 9+, not needed for Java 8)
    annotationProcessor group: 'systems.manifold', name: 'manifold-exceptions', version: '2020.1.15'
}
