...
dependencies {
    ...
    compile group: 'systems.manifold', name: 'manifold-exceptions', version: '2019.1.27'

    // Add manifold-exceptions to -processorpath for javac (for Java 9+, not needed for Java 8)
    annotationProcessor group: 'systems.manifold', name: 'manifold-exceptions', version: '2019.1.27'
}
