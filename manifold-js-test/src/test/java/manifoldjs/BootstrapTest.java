...
public class BootstrapTest {
  ...
  public void primordialProgramTest() {
    ...
    assertEquals(1, BasicJavascriptProgram.incrementAndGet());
    assertEquals(2, BasicJavascriptProgram.incrementAndGet());
  ...
  public void primordialClassTest() {
    ...
    assertEquals(1, instance1.incrementAndGet());
    assertEquals(2, instance1.incrementAndGet());
    ...
    assertEquals(1, instance2.incrementAndGet());
    assertEquals(2, instance2.incrementAndGet());
