...
> _**New!**_  
> * Manifold supports **Android Studio**! [Read more about it](https://manifold.systems/android.md).
> * Manifold supports **Kotlin**! [Read more about it](https://manifold.systems/kotlin.md).
