...
dependencies {
    compileOnly 'systems.manifold:manifold:2020.1.26-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-ext:2020.1.26-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-templates:2020.1.26-SNAPSHOT'
    implementation 'systems.manifold:manifold-templates-rt:2020.1.26-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-templates:2020.1.26-SNAPSHOT'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-templates/2020.1.26/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-templates/2020.1.26)

`manifold-templates-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-templates-rt/2020.1.26/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-templates-rt/2020.1.26)
