...
dependencies {
    compileOnly 'systems.manifold:manifold:2020.1.27-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-ext:2020.1.27-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-templates:2020.1.27-SNAPSHOT'
    implementation 'systems.manifold:manifold-templates-rt:2020.1.27-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-templates:2020.1.27-SNAPSHOT'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-templates/2020.1.27/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-templates/2020.1.27)

`manifold-templates-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-templates-rt/2020.1.27/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-templates-rt/2020.1.27)
