...
dependencies {
    compileOnly 'systems.manifold:manifold:2020.1.20-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-ext:2020.1.20-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-templates:2020.1.20-SNAPSHOT'
    implementation 'systems.manifold:manifold-templates-rt:2020.1.20-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-templates:2020.1.20-SNAPSHOT'
}
