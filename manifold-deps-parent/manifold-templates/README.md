...
### Java 8
Here is a sample `build.gradle` file using `manifold-templates` with **Java 8**:
```groovy
plugins {
    id 'java'
}
...
```groovy
rootProject.name = 'MyTemplatesProject'
```

### Java 11+
Here is a sample `build.gradle` file using `manifold-templates` with **Java 11**:
```groovy
plugins {
    id 'java'
}
