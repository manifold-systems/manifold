...
* Add a _compile-only_ scoped dependency on `manifold-templates` (Gradle: "compileOnly", Maven: "provided")
* Add a default scoped dependency on `manifold-templates-rt` (Gradle: "implementation", Maven: "compile")
...
dependencies {
    compileOnly 'systems.manifold:manifold:2020.1.24-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-ext:2020.1.24-SNAPSHOT'
    compileOnly 'systems.manifold:manifold-templates:2020.1.24-SNAPSHOT'
    implementation 'systems.manifold:manifold-templates-rt:2020.1.24-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-templates:2020.1.24-SNAPSHOT'
}
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
    ...
    <properties>
        ...
        <manifold.version>2020.1.24</manifold.version>
    </properties>
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-templates/2020.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-templates/2020.1.24)

`manifold-templates-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-templates-rt/2020.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-templates-rt/2020.1.24)
