...
public class RunDdl
{
  ...
  public static void main( String args[] )
  {
    try
    {
      ...
      String path = "C:/manifold-systems/manifold/manifold-deps-parent/manifold-sql-test-res/src/main/resources/manifold/sql/db/h2-sakila.mv.db";
      ...
      try( Reader reader = new InputStreamReader( RunDdl.class.getResourceAsStream( "/manifold/sql/ddl/h2-sakila-ddl.sql" ) ) )
      {
      ...
      try( Reader reader = new InputStreamReader( RunDdl.class.getResourceAsStream( "/manifold/sql/data/h2-sakila-data.sql" ) ) )
      {
        String script = StreamUtil.getContent( reader );
        List<String> commands = SqlScriptParser.getCommands( script );
        for( String command : commands )
