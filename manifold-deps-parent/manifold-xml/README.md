...
dependencies {
    implementation 'systems.manifold:manifold-xml-rt:2020.1.51-SNAPSHOT'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-xml:2020.1.51-SNAPSHOT'
}
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
    ...
    <properties>
        ...
        <manifold.version>2020.1.51</manifold.version>
    </properties>
...
`manifold-xml`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml/2020.1.51/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml/2020.1.51)

`manifold-xml-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml-rt/2020.1.51/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml-rt/2020.1.51)
