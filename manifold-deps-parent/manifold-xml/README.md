...
The `manifold-xml` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions 8 - 18.
...
version (8 - 18), the script takes care of the rest. 
```groovy
plugins {
    id 'java'
}
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-xml:2022.1.20'
    testAnnotationProcessor 'systems.manifold:manifold-xml:2022.1.20'
}
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
    ...
    <properties>
        ...
        <manifold.version>2022.1.20</manifold.version>
    </properties>
...
`manifold-xml`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml/2022.1.20/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml/2022.1.20)

`manifold-xml-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml-rt/2022.1.20/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml-rt/2022.1.20)
