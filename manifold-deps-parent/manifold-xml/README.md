...
The `manifold-xml` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions 8 - 12.
...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-xml', version: '2019.1.23'
    testCompile group: 'junit', name: 'junit', version: '4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-xml', version: '2019.1.23'
}
