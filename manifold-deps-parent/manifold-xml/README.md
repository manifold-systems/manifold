...
dependencies {
    compileOnly 'systems.manifold:manifold-xml:2020.1.19-SNAPSHOT'
    implementation 'systems.manifold:manifold-xml-rt:2020.1.19-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-xml:2020.1.19-SNAPSHOT'
}
...
`manifold-xml`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml/2020.1.19/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml/2020.1.19)

`manifold-xml-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml-rt/2020.1.19/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml-rt/2020.1.19)
