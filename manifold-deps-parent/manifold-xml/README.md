...
The `manifold-xml` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions 8 - 26.
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-xml:2026.1.11'
    testAnnotationProcessor 'systems.manifold:manifold-xml:2026.1.11'
}
...
`manifold-xml`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml/2026.1.11/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml/2026.1.11)

`manifold-xml-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-xml-rt/2026.1.11/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-xml-rt/2026.1.11)
