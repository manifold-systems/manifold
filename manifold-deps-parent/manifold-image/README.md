...
dependencies {
    compileOnly 'systems.manifold:manifold-image:2020.1.22-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-image:2020.1.22-SNAPSHOT'
}
...
`manifold-image`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-image/2020.1.22/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-image/2020.1.22)
