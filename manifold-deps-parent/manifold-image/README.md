...
dependencies {
    compileOnly 'systems.manifold:manifold-image:2020.1.24-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-image:2020.1.24-SNAPSHOT'
}
...
`manifold-image`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-image/2020.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-image/2020.1.24)
