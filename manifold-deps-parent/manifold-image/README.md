...
dependencies {
    compileOnly 'systems.manifold:manifold-rt:2024.1.29'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-image:2024.1.29'
    testAnnotationProcessor 'systems.manifold:manifold-image:2024.1.29'
}
...
`manifold-image`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-image/2024.1.29/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-image/2024.1.29)
