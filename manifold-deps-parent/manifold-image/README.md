...
dependencies {
    compileOnly 'systems.manifold:manifold-rt:2024.1.32'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-image:2024.1.32'
    testAnnotationProcessor 'systems.manifold:manifold-image:2024.1.32'
}
...
`manifold-image`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-image/2024.1.32/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-image/2024.1.32)
