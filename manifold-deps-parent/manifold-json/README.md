...
```java
User copy = User.copier(user).withName("Bob").build();
```
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2021.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2021.1.30)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2021.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2021.1.30)
