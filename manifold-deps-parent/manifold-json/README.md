...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2026.1.6'
    testAnnotationProcessor 'systems.manifold:manifold-json:2026.1.6'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2026.1.6/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2026.1.6)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2026.1.6/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2026.1.6)
