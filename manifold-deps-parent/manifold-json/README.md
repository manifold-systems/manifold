...
dependencies {
    implementation 'systems.manifold:manifold-json-rt:2021.1.3-SNAPSHOT'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-json:2021.1.3-SNAPSHOT'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2021.1.3/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2021.1.3)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2021.1.3/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2021.1.3)
