...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2024.1.49'
    testAnnotationProcessor 'systems.manifold:manifold-json:2024.1.49'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2024.1.49/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2024.1.49)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2024.1.49/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2024.1.49)
