...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2025.1.20'
    testAnnotationProcessor 'systems.manifold:manifold-json:2025.1.20'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2025.1.20/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2025.1.20)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2025.1.20/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2025.1.20)
