...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2023.1.23'
    testAnnotationProcessor 'systems.manifold:manifold-json:2023.1.23'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2023.1.23/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2023.1.23)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2023.1.23/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2023.1.23)
