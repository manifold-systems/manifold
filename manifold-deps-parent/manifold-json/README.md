...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2022.1.35'
    testAnnotationProcessor 'systems.manifold:manifold-json:2022.1.35'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2022.1.35/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2022.1.35)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2022.1.35/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2022.1.35)
