...
dependencies {
    implementation 'systems.manifold:manifold-json-rt:2020.1.28-SNAPSHOT'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-json:2020.1.28-SNAPSHOT'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2020.1.28/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2020.1.28)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2020.1.28/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2020.1.28)
