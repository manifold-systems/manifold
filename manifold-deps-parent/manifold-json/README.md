...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2022.1.13'
    testAnnotationProcessor 'systems.manifold:manifold-json:2022.1.13'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2022.1.13/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2022.1.13)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2022.1.13/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2022.1.13)
