...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2026.1.0'
    testAnnotationProcessor 'systems.manifold:manifold-json:2026.1.0'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2026.1.0/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2026.1.0)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2026.1.0/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2026.1.0)
