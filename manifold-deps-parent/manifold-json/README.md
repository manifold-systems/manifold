...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2024.1.21'
    testAnnotationProcessor 'systems.manifold:manifold-json:2024.1.21'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2024.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2024.1.21)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2024.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2024.1.21)
