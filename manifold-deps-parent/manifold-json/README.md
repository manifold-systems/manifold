...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2024.1.46'
    testAnnotationProcessor 'systems.manifold:manifold-json:2024.1.46'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2024.1.46/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2024.1.46)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2024.1.46/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2024.1.46)
