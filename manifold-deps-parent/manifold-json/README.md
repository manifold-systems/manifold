...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2022.1.6'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2022.1.6/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2022.1.6)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2022.1.6/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2022.1.6)
