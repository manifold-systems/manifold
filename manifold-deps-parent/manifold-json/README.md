...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-json:2022.1.30'
    testAnnotationProcessor 'systems.manifold:manifold-json:2022.1.30'
}
...
`manifold-json`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json/2022.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json/2022.1.30)

`manifold-json-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-json-rt/2022.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-json-rt/2022.1.30)
