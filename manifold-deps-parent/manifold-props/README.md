...
dependencies {
     implementation 'systems.manifold:manifold-props-rt:2021.1.5-SNAPSHOT'
     testImplementation 'junit:junit:4.12'
     // Add manifold to -processorpath for javac
     annotationProcessor 'systems.manifold:manifold-props:2021.1.5-SNAPSHOT'
}
...
`manifold-props`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-props/2021.1.5/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-props/2021.1.5)

`manifold-props-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-props-rt/2021.1.5/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-props-rt/2021.1.5)
