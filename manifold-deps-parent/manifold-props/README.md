...
### Javadoc agent (gradle)

See [Javadoc agent](#javadoc-agent-maven) maven config. 
(todo: provide gradle config)
...
`manifold-props`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-props/2021.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-props/2021.1.10)

`manifold-props-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-props-rt/2021.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-props-rt/2021.1.10)
