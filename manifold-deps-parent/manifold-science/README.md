...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-science', version: '2019.1.26'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-science', version: '2019.1.26'
}
