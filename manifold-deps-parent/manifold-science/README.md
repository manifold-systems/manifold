...
dependencies {
    implementation 'systems.manifold:manifold-science:2020.1.48-SNAPSHOT'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-science:2020.1.48-SNAPSHOT'
}
...
`manifold-science`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-science/2020.1.48/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-science/2020.1.48)
