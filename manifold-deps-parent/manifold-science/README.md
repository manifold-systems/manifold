...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-science', version: '2019.1.31'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-science', version: '2019.1.31'
}
