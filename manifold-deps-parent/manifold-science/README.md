...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-science', version: '2019.1.17'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-science', version: '2019.1.17'
}
