...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-science', version: '2020.1.8'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-science', version: '2020.1.8'
}
