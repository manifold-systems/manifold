...
public class InterfaceExclusionTest extends TestCase
{
  public void testInterfaceExcluded()
  {
    ...
    @Jailbreak PartWithInternalInterface part = (PartWithInternalInterface)myClass.foo;
  ...
  public void testInterfaceExcluded_Inherited()
  {
    ...
    @Jailbreak MyClassIntermediate intermediate = (MyClassIntermediate)myClass.foo;
  ...
  static class MyClass implements Foo, Bar
  {
    ...
    @link Foo foo = new PartWithInternalInterface();
  ...
  {
    // should only link Foo, not Bar bc @internal
    @link Foo foo = new MyClassIntermediate();
