...
dependencies {
    compileOnly 'systems.manifold:manifold-exceptions:2020.1.26-SNAPSHOT'
    // Note, you can omit the manifold-rt dependency if you use the `no-bootstrap` plugin option:
    //   -Xplugin:Manifold no-bootstrap
    implementation 'systems.manifold:manifold-rt:2020.1.26-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-exceptions', version: '2020.1.26'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-exceptions/2020.1.26/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-exceptions/2020.1.26)
