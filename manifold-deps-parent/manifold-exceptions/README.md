...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-exceptions', version: '2019.1.18'
    testCompile group: 'junit', name: 'junit', version: '4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-exceptions', version: '2019.1.18'
}
