...
dependencies {
    ...
    implementation 'systems.manifold:manifold-rt:2020.1.31-SNAPSHOT'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-exceptions', version: '2020.1.31'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-exceptions/2020.1.31/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-exceptions/2020.1.31)
