...
The `manifold-properties` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions 8 - 14.
...
dependencies {
    compileOnly 'systems.manifold:manifold-properties:2020.1.24-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-properties:2020.1.24-SNAPSHOT'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-properties/2020.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-properties/2020.1.24)
