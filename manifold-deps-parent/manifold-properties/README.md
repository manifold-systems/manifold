...
The `manifold-properties` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions8 - 20.
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-properties:2023.1.7'
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-properties/2023.1.7/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-properties/2023.1.7)
