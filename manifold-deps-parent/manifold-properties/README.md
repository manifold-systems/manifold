...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-properties', version: '2020.1.8'
    testCompile group: 'junit', name: 'junit', version: '4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-properties', version: '2020.1.8'
}
