...
The `manifold-properties` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions 8 - 16.
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-properties:2021.1.21-SNAPSHOT'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-properties/2021.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-properties/2021.1.21)
