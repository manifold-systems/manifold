...
The `manifold-properties` dependency works with all build tooling, including Maven and Gradle. It also works with Java versions 8 - 25.
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-properties:2025.1.30'
    compileOnly 'systems.manifold:manifold-rt:2025.1.30'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-properties/2025.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-properties/2025.1.30)
