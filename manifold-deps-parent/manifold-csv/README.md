...
dependencies {
    implementation 'systems.manifold:manifold-csv-rt:2020.1.36'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-csv', version: '2020.1.36'
}
...
`manifold-csv`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv/2020.1.36/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv/2020.1.36)

`manifold-csv-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv-rt/2020.1.36/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv-rt/2020.1.36)
