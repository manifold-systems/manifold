...
dependencies {
    implementation 'systems.manifold:manifold-csv-rt:2026.1.12'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-csv', version: '2026.1.12'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-csv', version: '2026.1.12'
}
...
`manifold-csv`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv/2026.1.12/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv/2026.1.12)

`manifold-csv-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv-rt/2026.1.12/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv-rt/2026.1.12)
