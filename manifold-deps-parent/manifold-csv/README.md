...
Manifold plugs into the Java compiler to enable you to use CSV and Java seamlessly -- CSV files are types. You use CSV
...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-xml', version: '2019.1.27'
    testCompile group: 'junit', name: 'junit', version: '4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-xml', version: '2019.1.27'
}
