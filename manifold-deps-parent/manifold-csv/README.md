...
dependencies {
    implementation 'systems.manifold:manifold-csv-rt:2021.1.26'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-csv', version: '2021.1.26'
}
...
<project csvns="http://maven.apache.org/POM/4.0.0" csvns:xsi="http://www.w3.org/2001/CSVSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
    ...
    <properties>
        ...
        <manifold.version>2021.1.26</manifold.version>
    </properties>
...
`manifold-csv`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv/2021.1.26/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv/2021.1.26)

`manifold-csv-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv-rt/2021.1.26/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv-rt/2021.1.26)
