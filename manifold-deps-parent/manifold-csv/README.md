...
dependencies {
    implementation 'systems.manifold:manifold-csv-rt:2024.1.21'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-csv', version: '2024.1.21'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-csv', version: '2024.1.21'
}
...
`manifold-csv`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv/2024.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv/2024.1.21)

`manifold-csv-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-csv-rt/2024.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-csv-rt/2024.1.21)
