...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-collections', version: '2019.1.30'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-collections', version: '2019.1.30'
}
