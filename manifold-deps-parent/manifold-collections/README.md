...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-collections', version: '2019.1.15'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-collections', version: '2019.1.15'
}
