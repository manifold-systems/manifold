...
dependencies {
    compileOnly 'systems.manifold:manifold-js:2020.1.20-SNAPSHOT'
    implementation 'systems.manifold:manifold-js-rt:2020.1.20-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-js:2020.1.20-SNAPSHOT'
}
