...
from this condition: a part's interfaces may therefore be rooted at two or more
distinct identities, including the part itself and one or more composites.
...
to the claiming composite. Otherwise, \code{this} remains the part itself.

The possession example in Section~\ref{sec:model} demonstrates this directly.
...
\code{Combatant}, making it a multi-rooted part.
...
virtual call; the two properties were never inherently in conflict.
