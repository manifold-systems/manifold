...
We present Parts, a general delegation model that meets this challenge by unifying independent runtime components,
...
\begin{description}
  \item[claim] a part's claimed interfaces are those that one or more composites have linked: the composite "claims" its
  linked interfaces, becoming their exclusive identity within their implementing parts.

  \item[component] a class nominally implementing one or more interfaces available for delegation.
