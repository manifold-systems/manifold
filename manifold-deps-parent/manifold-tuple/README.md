...
![latest](https://img.shields.io/badge/latest-v2024.1.34-royalblue.svg)
...
dependencies {
    implementation 'systems.manifold:manifold-tuple-rt:2024.1.34'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2024.1.34'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2024.1.34'
}
...
`manifold-tuple`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple/2024.1.34/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple/2024.1.34)

`manifold-tuple-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple-rt/2024.1.34/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple-rt/2024.1.34)
