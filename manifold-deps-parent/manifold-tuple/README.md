...
dependencies {
    implementation 'systems.manifold:manifold-tuple-rt:2026.1.7'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2026.1.7'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2026.1.7'
}
...
`manifold-tuple`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple/2026.1.7/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple/2026.1.7)

`manifold-tuple-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple-rt/2026.1.7/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple-rt/2026.1.7)
