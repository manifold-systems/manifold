...
dependencies {
    implementation 'systems.manifold:manifold-tuple-rt:2025.1.9'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2025.1.9'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2025.1.9'
}
...
`manifold-tuple`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple/2025.1.9/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple/2025.1.9)

`manifold-tuple-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple-rt/2025.1.9/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple-rt/2025.1.9)
