...
![latest](https://img.shields.io/badge/latest-v2025.1.23-royalblue.svg)
...
dependencies {
    implementation 'systems.manifold:manifold-tuple-rt:2025.1.23'
    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2025.1.23'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-tuple', version: '2025.1.23'
}
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
    ...
    <properties>
        ...
        <manifold.version>2025.1.23</manifold.version>
    </properties>
...
`manifold-tuple`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple/2025.1.23/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple/2025.1.23)

`manifold-tuple-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-tuple-rt/2025.1.23/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-tuple-rt/2025.1.23)
