...
* Add a _compile-only_ scoped dependency on `manifold-yaml` (Gradle: "compileOnly", Maven: "provided")
* Add a default scoped dependency on `manifold-yaml-rt` (Gradle: "implementation", Maven: "compile")
...
dependencies {
    compileOnly 'systems.manifold:manifold-yaml:2020.1.24-SNAPSHOT'
    implementation 'systems.manifold:manifold-yaml-rt:2020.1.24-SNAPSHOT'

    testImplementation 'junit:junit:4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-yaml:2020.1.24-SNAPSHOT'
}
...
`manifold-yaml`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-yaml/2020.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-yaml/2020.1.24)

`manifold-yaml-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-yaml-rt/2020.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-yaml-rt/2020.1.24)
