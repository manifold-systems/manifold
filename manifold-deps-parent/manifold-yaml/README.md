...
dependencies {
    implementation 'systems.manifold:manifold-yaml-rt:2021.1.21-SNAPSHOT'
    testImplementation 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor 'systems.manifold:manifold-yaml:2021.1.21-SNAPSHOT'
}
...
`manifold-yaml`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-yaml/2021.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-yaml/2021.1.21)

`manifold-yaml-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-yaml-rt/2021.1.21/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-yaml-rt/2021.1.21)
