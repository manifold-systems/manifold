...
public class ChromeTest extends TestCase
{
  public void testChrome()
  {
    ...
    List<chrome.content_scripts> content_scripts = chr.getContent_scripts();
    ...
    List<chrome.file_browser_handlers> file_browser_handlers = chr.getFile_browser_handlers();
