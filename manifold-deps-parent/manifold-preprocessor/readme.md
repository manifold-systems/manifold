...
versions 8 - 18 and supports `-source` compatibility with any Java version.  Note this dependency is exclusive to
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-preprocessor:2022.1.20'
    testAnnotationProcessor 'systems.manifold:manifold-preprocessor:2022.1.20'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-preprocessor/2022.1.20/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-preprocessor/2022.1.20)
