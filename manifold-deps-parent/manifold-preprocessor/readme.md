...
versions 8 - 25 and supports `-source` compatibility with any Java version.  Note this dependency is exclusive to
...
dependencies {
    ...
    annotationProcessor 'systems.manifold:manifold-preprocessor:2025.1.30'
    testAnnotationProcessor 'systems.manifold:manifold-preprocessor:2025.1.30'
}
...
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-preprocessor/2025.1.30/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-preprocessor/2025.1.30)
