...
dependencies {
    implementation group: 'systems.manifold', name: 'manifold-darkj', version: '2023.1.7'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-darkj', version: '2023.1.7'
}
