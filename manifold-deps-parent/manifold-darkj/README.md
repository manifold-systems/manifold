...
dependencies {
    implementation group: 'systems.manifold', name: 'manifold-darkj', version: '2023.1.17'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-darkj', version: '2023.1.17'
}
