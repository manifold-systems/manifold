...
dependencies {
    implementation group: 'systems.manifold', name: 'manifold-darkj', version: '2020.1.42'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-darkj', version: '2020.1.42'
}
