...
dependencies {
    implementation group: 'systems.manifold', name: 'manifold-darkj', version: '2024.1.52'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-darkj', version: '2024.1.52'
}
