...
dependencies {
    implementation group: 'systems.manifold', name: 'manifold-darkj', version: '2023.1.26'
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-darkj', version: '2023.1.26'
}
