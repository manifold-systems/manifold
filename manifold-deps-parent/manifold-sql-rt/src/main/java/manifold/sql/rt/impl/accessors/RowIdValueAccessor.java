...
public class RowIdValueAccessor implements ValueAccessor
{
  @Override
  ...
  @Override
  public RowId getRowValue( ResultSet rs, BaseElement elem ) throws SQLException
  {
    return rs.getRowId( elem.getPosition() );
  }
