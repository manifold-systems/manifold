...
public class CrudTest extends Db2DdlServerTest
{
  @Test
  public void testCreate() throws SQLException
  {
    TxScope txScope = Db2Sakila.newScope();
    ...
    auto row = "[.sql:Db2Sakila/] SELECT country_id FROM Country where country = 'mycountry'"
      .fetchOne( txScope );
