...
public class CrudTest extends MysqlDdlServerTest
{
  @Test
  public void testCreate() throws SQLException
  {
    TxScope txScope = MysqlSakila.newScope();
    ...
    auto row = "[.sql:MysqlSakila/] SELECT country_id FROM Country where country = 'mycountry'"
      .fetchOne( txScope );
