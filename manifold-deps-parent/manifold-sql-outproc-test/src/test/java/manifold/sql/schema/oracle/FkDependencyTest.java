...
public class FkDependencyTest extends OracleDdlServerTest
{
  @Test
  public void testOneDependency() throws SQLException
  {
    ...
    Country countryFromSql = "[.sql:OracleSakila/] select * from country where country_id = :country_id".fetchOne( country.getCountryId() );
