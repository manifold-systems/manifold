...
import manifold.sql.schema.simple.db2.Db2Sakila.City;
import manifold.sql.schema.simple.db2.Db2Sakila.Country;
...
public class FkDependencyTest extends Db2DdlServerTest
{
  @Test
  public void testOneDependency() throws SQLException
  {
    ...
    Country countryFromSql = "[.sql:Db2Sakila/] select * from country where country_id = :country_id".fetchOne( country.getCountryId() );
