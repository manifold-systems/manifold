...
public class FkDependencyTest extends PostgresDdlServerTest
{
  @Test
  public void testOneDependency() throws SQLException
  {
    ...
    Country countryFromSql = "[.sql:PostgresSakila/] select * from country where country_id = :country_id".fetchOne( country.getCountryId() );
