...
public class CrudTest extends SqlserverDdlServerTest
{
  @Test
  public void testCreate() throws SQLException
  {
    TxScope txScope = SqlserverSakila.newScope();
    ...
    auto row = "[.sql:SqlserverSakila/] SELECT country_id FROM Country where country = 'mycountry'"
      .fetchOne( txScope );
