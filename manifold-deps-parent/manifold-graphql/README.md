...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-graphql', version: '2019.1.21'
    testCompile group: 'junit', name: 'junit', version: '4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-graphql', version: '2019.1.21'
}
