...
> annotationProcessor 'systems.manifold:manifold-props:2022.1.24'
>``` 
...
dependencies {
     ...
     annotationProcessor 'systems.manifold:manifold-graphql:2022.1.24'
     testAnnotationProcessor 'systems.manifold:manifold-graphql:2022.1.24'
}
...
`manifold-graphql`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql/2022.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql/2022.1.24)

`manifold-graphql-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql-rt/2022.1.24/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql-rt/2022.1.24)
