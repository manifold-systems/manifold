...
> annotationProcessor 'systems.manifold:manifold-props:2023.1.23'
>``` 
...
dependencies {
     ...
     annotationProcessor 'systems.manifold:manifold-graphql:2023.1.23'
     testAnnotationProcessor 'systems.manifold:manifold-graphql:2023.1.23'
}
...
`manifold-graphql`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql/2023.1.23/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql/2023.1.23)

`manifold-graphql-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql-rt/2023.1.23/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql-rt/2023.1.23)
