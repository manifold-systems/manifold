...
> annotationProcessor 'systems.manifold:manifold-props:2024.1.10'
>``` 
...
dependencies {
     ...
     annotationProcessor 'systems.manifold:manifold-graphql:2024.1.10'
     testAnnotationProcessor 'systems.manifold:manifold-graphql:2024.1.10'
}
...
`manifold-graphql`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql/2024.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql/2024.1.10)

`manifold-graphql-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql-rt/2024.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql-rt/2024.1.10)
