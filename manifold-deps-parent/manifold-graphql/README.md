...
> annotationProcessor 'systems.manifold:manifold-props:2022.1.25'
>``` 
...
dependencies {
     ...
     annotationProcessor 'systems.manifold:manifold-graphql:2022.1.25'
     testAnnotationProcessor 'systems.manifold:manifold-graphql:2022.1.25'
}
...
`manifold-graphql`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql/2022.1.25/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql/2022.1.25)

`manifold-graphql-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql-rt/2022.1.25/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql-rt/2022.1.25)
