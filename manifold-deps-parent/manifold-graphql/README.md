...
> annotationProcessor 'systems.manifold:manifold-props:2023.1.0'
>``` 
...
dependencies {
     ...
     annotationProcessor 'systems.manifold:manifold-graphql:2023.1.0'
     testAnnotationProcessor 'systems.manifold:manifold-graphql:2023.1.0'
}
...
`manifold-graphql`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql/2023.1.0/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql/2023.1.0)

`manifold-graphql-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql-rt/2023.1.0/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql-rt/2023.1.0)
