...
> annotationProcessor 'systems.manifold:manifold-props:2022.1.3'
>``` 
...
dependencies {
     ...
     annotationProcessor 'systems.manifold:manifold-graphql:2022.1.3'
}
...
`manifold-graphql`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql/2022.1.3/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql/2022.1.3)

`manifold-graphql-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-graphql-rt/2022.1.3/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-graphql-rt/2022.1.3)
