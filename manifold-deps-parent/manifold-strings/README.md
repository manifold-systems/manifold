...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-strings', version: '2020.1.6'
    testCompile group: 'junit', name: 'junit', version: '4.12'

    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-strings', version: '2020.1.6'
}
