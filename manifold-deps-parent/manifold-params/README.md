...
This plugin **supports JDK versions 8 - 26+** and integrates seamlessly with **IntelliJ IDEA** and **Android Studio**.
...
This project works with all Java build tools, including Maven and Gradle, and supports Java versions 8 - 26.
...
LTS release (8 - 26) or latest JDK release.
```groovy
plugins {
    id 'java'
}
...
dependencies {
     implementation 'systems.manifold:manifold-params-rt:2026.1.11'
     testImplementation 'junit:junit:4.12'
     // Add manifold to -processorpath for javac
     annotationProcessor 'systems.manifold:manifold-params:2026.1.11'
     testAnnotationProcessor 'systems.manifold:manifold-params:2026.1.11'
}
...
`manifold-params`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-params/2026.1.11/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-params/2026.1.11)

`manifold-params-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-params-rt/2026.1.11/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-params-rt/2026.1.11)
