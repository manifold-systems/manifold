...
dependencies {
     implementation 'systems.manifold:manifold-params-rt:2026.1.6'
     testImplementation 'junit:junit:4.12'
     // Add manifold to -processorpath for javac
     annotationProcessor 'systems.manifold:manifold-params:2026.1.6'
     testAnnotationProcessor 'systems.manifold:manifold-params:2026.1.6'
}
...
`manifold-params`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-params/2026.1.6/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-params/2026.1.6)

`manifold-params-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-params-rt/2026.1.6/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-params-rt/2026.1.6)
