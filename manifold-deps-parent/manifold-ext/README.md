...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-ext', version: '2023.1.1'
    testAnnotationProcessor group: 'systems.manifold', name: 'manifold-ext', version: '2023.1.1'
}
...
`manifold-ext`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-ext/2023.1.1/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-ext/2023.1.1)

`manifold-ext-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-ext-rt/2023.1.1/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-ext-rt/2023.1.1)
