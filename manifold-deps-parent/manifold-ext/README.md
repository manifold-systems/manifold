...
//    implementation 'systems.manifold:manifold-ext:2020.1.50'   

    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-ext', version: '2020.1.50'
}
...
`manifold-ext`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-ext/2020.1.50/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-ext/2020.1.50)

`manifold-ext-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-ext-rt/2020.1.50/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-ext-rt/2020.1.50)
