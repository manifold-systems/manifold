...
>Note you can replace the `manifold-ext` dependency with **`manifold-all`** as a quick way to gain access to all of
Manifold's features.
...
dependencies {
    compile group: 'systems.manifold', name: 'manifold-ext', version: '2019.1.10'
...
dependencies {
    ...
    annotationProcessor group: 'systems.manifold', name: 'manifold-ext', version: '2019.1.10'
}
