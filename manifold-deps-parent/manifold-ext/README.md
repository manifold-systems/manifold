...
//    implementation 'systems.manifold:manifold-ext:2021.1.10'   

    testCompile 'junit:junit:4.12'
    // Add manifold to -processorpath for javac
    annotationProcessor group: 'systems.manifold', name: 'manifold-ext', version: '2021.1.10'
}
...
`manifold-ext`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-ext/2021.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-ext/2021.1.10)

`manifold-ext-rt`:<br>
[![javadoc](https://javadoc.io/badge2/systems.manifold/manifold-ext-rt/2021.1.10/javadoc.svg)](https://javadoc.io/doc/systems.manifold/manifold-ext-rt/2021.1.10)
